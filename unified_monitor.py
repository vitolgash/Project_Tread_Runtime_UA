...
def main():
    ...
    if alerts:
        ...
        save(log_path, {"timestamp": datetime.now().isoformat(), "alerts": alerts, "law": law_report, "sanctions": sanctions_report})
        send_tg("Project Tread — обновления:\n" + "\n".join(alerts))

    print(json.dumps({"laws": law_report, "sanctions": sanctions_report}, ensure_ascii=False, indent=2))
